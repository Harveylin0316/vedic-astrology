...
function scoreTier(rawScore) {
  // 2026 校準（3000 人實證 + 391 celebrity 驗證）· 保留「稀有度」框架
  //   · 實證顯示 celebrity vs random yoga 分佈幾乎相同（lift ≈ 1）
  //   · 這意味稀有度 ≠ 成功 — UI 上另以 disclaimer 明確告知用戶
  //   · tier title 走保守中性，避免被誤讀為性格或成功預測
