...
// ═════════════════════════════════════════════════════════════
// 3️⃣-a Moon Traits — 月亮星座優缺點（給人的相處感受）
// ═════════════════════════════════════════════════════════════
export const moonTraits = {
  Mesha: {
    strengths: ['感情直爽不裝', '說到做到', '熱情會感染人', '不記仇大氣'],
    weaknesses: ['脾氣一來不看場合', '不耐煩', '衝動做決定', '情緒寫在臉上']
  },
  Vrishabha: {
    strengths: ['情感穩定不斷線', '超忠誠', '會把家顧得穩穩', '品味好'],
    weaknesses: ['固執到翻白眼', '吃醋悶內傷', '抗拒改變', '懶起來連動都不想']
  },
  Mithuna: {
    strengths: ['聊天超有趣', '會逗人笑', '適應力驚人', '朋友遍天下'],
    weaknesses: ['三心二意', '答應的事常忘', '想太多失眠', '情感深度留不住人']
  },
  Karka: {
    strengths: ['照顧人無敵細', '共感力爆棚', '記得所有細節', '朋友的心靈支柱'],
    weaknesses: ['玻璃心', '愛冷戰', '黏到伴侶有壓力', '爸媽的話大過伴侶']
  },
  Simha: {
    strengths: ['慷慨大方', '挺朋友到底', '氣場強', '愛恨分明有魅力'],
    weaknesses: ['愛面子', '被冷落會幼稚', '愛聽好話', '花錢不手軟']
  },
  Kanya: {
    strengths: ['超可靠靠譜', '細心記事王', '你的事比自己的重要', '規劃神'],
    weaknesses: ['太挑剔', '批評太直接', '焦慮內耗', '完美主義綁架自己']
  },
  Tula: {
    strengths: ['人緣超好', '會哄人', '大氣不小氣', '溫柔有修養'],
    weaknesses: ['決定能拖 3 天', '表面和氣心裡有帳', '討好型', '不敢說不']
  },
  Vrishchika: {
    strengths: ['忠誠到傳奇', '看穿人心', '意志堅強', '保護愛的人'],
    weaknesses: ['記仇記到天荒地老', '占有慾爆表', '多疑', '愛玩冷戰']
  },
  Dhanu: {
    strengths: ['樂觀傳染力', '眼界寬廣', '不小氣', '給對方自由'],
    weaknesses: ['說話不經大腦', '承諾恐懼', '好為人師', '常放鴿子']
  },
  Makara: {
    strengths: ['超可靠', '抗壓強', '默默守護', '長期主義者'],
    weaknesses: ['情感表達障礙', '工作狂', '太嚴肅', '表面冷內心熱但不會說']
  },
  Kumbha: {
    strengths: ['尊重他人選擇', '思想獨立', '不愛八卦', '創意金句多'],
    weaknesses: ['情感抽離', '該親密時會逃', '固執己見', '顯得冷漠']
  },
  Meena: {
    strengths: ['無條件愛人', '直覺超準', '共情力滿分', '用靈感給建議'],
    weaknesses: ['界線模糊', '愛逃避', '情緒起伏大', '容易被利用']
  }
}

// ═════════════════════════════════════════════════════════════
// 3️⃣-b Sun Traits — 太陽星座優缺點（核心人格、職場樣子）
// ═════════════════════════════════════════════════════════════
export const sunTraits = {
  Mesha: {
    strengths: ['行動力一流', '壓力越大越強', '敢於開創', '領軍衝鋒'],
    weaknesses: ['衝太快燒光子彈', '不聽勸', '樹敵快', '三分鐘熱度']
  },
  Vrishabha: {
    strengths: ['耐性驚人', '長期累積有深度', '專業紮實', '審美一流'],
    weaknesses: ['過度貪穩', '動作慢', '物質主義', '拒絕改變']
  },
  Mithuna: {
    strengths: ['學習超快', '一心多用', '溝通大師', '創意無邊'],
    weaknesses: ['淺嘗輒止', '專注力差', '說多做少', '容易膩']
  },
  Karka: {
    strengths: ['直覺準', '能讀懂氣氛', '照顧全局', '家庭觀念強'],
    weaknesses: ['公私混在一起', '情緒影響工作', '懷舊卡住不動', '媽寶傾向']
  },
  Simha: {
    strengths: ['自帶光環', '領導魅力', '創造力強', '大氣格局'],
    weaknesses: ['愛被誇讚', '面子重', '花錢大手大腳', '自我中心']
  },
  Kanya: {
    strengths: ['專業技能深厚', '細節大師', '解決問題強', '可靠'],
    weaknesses: ['過度完美', '批評狂', '焦慮爆棚', '小事糾結']
  },
  Tula: {
    strengths: ['美感好', '公關之王', '客觀公正', '外交高手'],
    weaknesses: ['決斷力差', '討好型人格', '害怕衝突', '拖延']
  },
  Vrishchika: {
    strengths: ['洞察人心', '意志堅強', '專注深挖', '轉化力'],
    weaknesses: ['控制慾強', '疑心病', '記仇', '情緒放毒']
  },
  Dhanu: {
    strengths: ['格局大視野廣', '樂觀感染力', '教學天賦', '勇於闖蕩'],
    weaknesses: ['承諾空話多', '不耐細節', '說話直傷人', '跑得快']
  },
  Makara: {
    strengths: ['抗壓無敵', '紀律大師', '長遠規劃', '越老越強'],
    weaknesses: ['工作狂', '不會放鬆', '情感匱乏', '生活無趣']
  },
  Kumbha: {
    strengths: ['原創思維', '前瞻視野', '獨立思考', '人道精神'],
    weaknesses: ['太前衛別人跟不上', '情感冷淡', '叛逆為叛逆', '脫離現實']
  },
  Meena: {
    strengths: ['藝術天賦', '慈悲心', '療癒能力', '想像力爆棚'],
    weaknesses: ['太好講話被利用', '逃避現實', '成癮傾向', '邊界模糊']
  }
}

// 合併三者（Lagna + Moon + Sun）去重，輸出「優點 vs 缺點」對比
export function getPersonalitySummary({ lagna, moon, sun }) {
  const lag = lagnaReadings[lagna]
  const m = moonTraits[moon]
  const s = sunTraits[sun]
  const strengths = [
    ...((lag && lag.lovableTraits) || []),
    ...((m && m.strengths) || []),
    ...((s && s.strengths) || [])
  ]
  const weaknesses = [
