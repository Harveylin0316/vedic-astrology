...
// ═════════════════════════════════════════════════════════════
// 8️⃣ Vimshottari Dasha 大運 — 人生階段解讀
// ═════════════════════════════════════════════════════════════
export const dashaReadings = {
  Ketu: {
    ...
    years: 7,
    theme: '出離 · 靈性 · 內觀',
    goodFor: ['靈修、冥想', '放下舊關係 / 舊工作', '專研神祕學或哲學'],
    watchOut: ['突然的失去', '意外、健康異常', '感情被動動盪'],
    vibe: '這 7 年像在「清空雜物」。舊緣份會離開、不屬於你的會自然消失。學會放手、不強求。'
  },
  Venus: {
    name: 'Venus 金星大運',
    years: 20,
    theme: '愛情 · 藝術 · 奢華 · 配偶',
    goodFor: ['戀愛結婚', '藝術創作、美學事業', '享受物質、增添魅力'],
    watchOut: ['感情三角', '揮霍無度', '依賴伴侶而失去自我'],
    vibe: '20 年的「愛與美」大運。最容易遇到命定伴侶、最容易因藝術或美感致富。是人生最甜的階段。'
  },
  Sun: {
    name: 'Sun 太陽大運',
    years: 6,
    theme: '名聲 · 父親 · 權威 · 政府',
    goodFor: ['升遷、考公職', '成為某個領域的代表', '與父親和解'],
    watchOut: ['跟上級衝突', '驕傲自滿、樹敵', '眼睛、心臟健康'],
    vibe: '6 年的發光時刻。如果本命太陽強，這是你登頂的時候；如果弱，要學會低調別硬撐。'
  },
  Moon: {
    name: 'Moon 月亮大運',
    years: 10,
    theme: '情感 · 家庭 · 母親 · 房產',
    goodFor: ['結婚生子', '買房買車', '情感療癒'],
    watchOut: ['情緒起伏大', '與母親或女性有課題', '太敏感內耗'],
    vibe: '10 年的「情感豐盛」大運。家會是核心話題、直覺會變強、心會更敏銳。'
  },
  Mars: {
    name: 'Mars 火星大運',
    years: 7,
    theme: '競爭 · 勇氣 · 房產 · 手術',
    goodFor: ['創業、衝刺', '買房、投資不動產', '運動、健身'],
    watchOut: ['意外受傷、手術', '跟兄弟或同事衝突', '暴躁失控'],
    vibe: '7 年的「行動派」大運。衝勁十足但也容易衝動。是買房、創業、闖蕩的好時機。'
  },
  Rahu: {
    name: 'Rahu 羅睺大運',
    years: 18,
    theme: '慾望 · 海外 · 科技 · 顛覆',
    goodFor: ['出國發展', '科技 / 新創 / 加密貨幣', '突破舊有身份'],
    watchOut: ['沉迷、上癮', '表面光鮮內心空虛', '人際關係詭異'],
    vibe: '18 年最戲劇化的大運。會讓你嚐到很多「前所未有」的事，但也容易迷失。'
  },
  Jupiter: {
    name: 'Jupiter 木星大運',
    years: 16,
    theme: '智慧 · 子嗣 · 財富 · 導師',
    goodFor: ['進修、出國念書', '生小孩', '擴張事業、當導師'],
    watchOut: ['過度樂觀', '體重上升', '承諾太多做不完'],
    vibe: '16 年最有福氣的大運。貴人多、機會多、運勢擴張。是人生「開花結果」階段。'
  },
  Saturn: {
    name: 'Saturn 土星大運',
    years: 19,
    theme: '紀律 · 責任 · 延遲 · 業力',
    goodFor: ['長期計畫、築地基', '進入政府 / 大企業', '學習耐心'],
    watchOut: ['憂鬱、孤獨感', '工作壓力大', '感情延遲或冷淡'],
    vibe: '19 年最磨人但也最鍛鍊的大運。前期痛後期成。熬過去你會變成自己尊敬的人。'
  },
  Mercury: {
    name: 'Mercury 水星大運',
    years: 17,
    theme: '學習 · 溝通 · 生意 · 人脈',
    goodFor: ['考試、出書、授課', '做生意、擴張人脈', '多元收入'],
    watchOut: ['想太多失眠', '口舌是非', '簽合約要看清'],
    vibe: '17 年的「智慧與財商」大運。腦袋動得快、生意機會多、人脈爆炸成長。'
  }
}
